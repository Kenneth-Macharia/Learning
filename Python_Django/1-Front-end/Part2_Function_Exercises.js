...
function caught_speeding(speed, is_birthday){
  ...
  // if ((speed <= 60 && is_birthday === false) || (speed <= 65 && is_birthday === true)) {
  //   ticket = 0;
  // } else if ((speed > 60 && speed <= 80 && is_birthday === false) || (speed > 65 && speed <= 85 &&    is_birthday === true)) {
  //   ticket = 1;
  // } else if ((speed > 80 && is_birthday === false) || (speed > 86 && is_birthday === true)) {
  //   ticket = 2;
  // }
  // return ticket;
